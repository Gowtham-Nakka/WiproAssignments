...
import {
  Breakpoints
} from "./chunk-MS75DBEQ.js";
import {
  CdkDialogContainer,
  Dialog,
  DialogModule
} from "./chunk-GDBM6ZAB.js";
import {
  Overlay
} from "./chunk-3AN3CMT3.js";
import "./chunk-IEKDUPL3.js";
import {
  CdkPortalOutlet,
  PortalModule
} from "./chunk-TPIWDW6K.js";
...
var MatBottomSheetRef = class {
  ...
  constructor(_ref, config, containerInstance) {
    ...
    containerInstance._animationStateChanged.pipe((0, import_operators.filter)((event) => event.phase === "done" && event.toState === "visible"), (0, import_operators.take)(1)).subscribe(() => {
      this._afterOpened.next();
      this._afterOpened.complete();
    });
    containerInstance._animationStateChanged.pipe((0, import_operators.filter)((event) => event.phase === "done" && event.toState === "hidden"), (0, import_operators.take)(1)).subscribe(() => {
  ...
  dismiss(result) {
    ...
    this.containerInstance._animationStateChanged.pipe((0, import_operators.filter)((event) => event.phase === "start"), (0, import_operators.take)(1)).subscribe(() => {
